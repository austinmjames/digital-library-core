...
/**
 * Gateway Orchestrator (v22.1 - Clean Registry)
 * Filepath: app/page.tsx
 * Role: Master Events Overview & Unified Temporal Registry.
 * Architecture: Optimized for Benchmarks and Roadmap.
 * Fixes: Restored missing Link import from next/link.
 */
  ...
  useEffect(() => {
    async function loadTemporalData() {
      ...
      try {
        ...
        console.error("δ Infrastructure: Temporal sync failed.", err);
      } finally {
        setIsDataLoading(false);
      }
    }
    loadTemporalData();
  }, [activeLocation, effectiveDate]);
