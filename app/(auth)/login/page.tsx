 ...
 * Role: Authentication entry point with PRD-compliant Social + Email logic.
 * Design Strategy: Inverse Theme (Sidebar/Logo: zinc-950, Page: Paper).
 * UI: Implements DrashInput and DrashButton tokens.
 */
    ...
    <div className="min-h-screen bg-[#FAF9F6] flex flex-col items-center justify-center p-6 selection:bg-zinc-950 selection:text-white">
      <div className="w-full max-w-md animate-in fade-in zoom-in-95 duration-500">
        ...
        <div className="bg-white border border-zinc-200 rounded-[2rem] p-8 shadow-[0_20px_50px_rgba(0,0,0,0.05)] relative overflow-hidden">
          ...
          <div className="relative space-y-6">
            ...
            <form onSubmit={handleEmailLogin} className="space-y-4">
              ...
              {/* DrashInput Token Implementation */}
              <div className="space-y-1.5">
                ...
                <div className="relative group">
                  ...
                  <input
                    ...
                    className="w-full pl-12 pr-4 py-3.5 bg-zinc-50 border border-zinc-200 rounded-xl focus:ring-4 focus:ring-zinc-950/5 focus:border-zinc-950 outline-none transition-all text-sm font-medium placeholder:text-zinc-300"
              ...
              {/* DrashButton Token Implementation */}
              <button
                type="submit"
                disabled={loading}
                className="w-full bg-zinc-950 text-white py-4 rounded-xl font-bold uppercase text-[10px] tracking-[0.25em] flex items-center justify-center gap-2 hover:bg-zinc-800 transition-all shadow-xl hover:shadow-zinc-950/20 active:scale-[0.97] disabled:opacity-50 mt-4 overflow-hidden relative group"
              >
        ...
        <p className="mt-12 text-[10px] text-zinc-400 text-center uppercase tracking-widest leading-loose max-w-xs mx-auto opacity-50">
          By continuing, you agree to the DrashX <br /> Terms of Service &
          Privacy Policy.
        </p>
      </div>
    </div>
